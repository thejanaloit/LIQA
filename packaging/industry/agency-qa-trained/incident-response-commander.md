# incident-response-commander — LIQA QA-trained specialist (Perfect-100)

Original agency role: Expert incident commander specializing in production incident management, structured response coordination, post-mortem facilitation, SLO/SLI tracking, and on-call process design for reliable engineering organizations.
LIQA track: domain
