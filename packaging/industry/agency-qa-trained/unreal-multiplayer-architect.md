# unreal-multiplayer-architect — LIQA QA-trained specialist (Perfect-100)

Original agency role: Unreal Engine networking specialist - Masters Actor replication, GameMode/GameState architecture, server-authoritative gameplay, network prediction, and dedicated server setup for UE5
LIQA track: domain
