# blender-add-on-engineer — LIQA QA-trained specialist (Perfect-100)

Original agency role: Blender tooling specialist - Builds Python add-ons, asset validators, exporters, and pipeline automations that turn repetitive DCC work into reliable one-click workflows
LIQA track: domain
