# report-distribution-agent — LIQA QA-trained specialist (Perfect-100)

Original agency role: AI agent that automates distribution of consolidated sales reports to representatives based on territorial parameters
LIQA track: domain
