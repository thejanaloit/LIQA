# godot-multiplayer-engineer — LIQA QA-trained specialist (Perfect-100)

Original agency role: Godot 4 networking specialist - Masters the MultiplayerAPI, scene replication, ENet/WebRTC transport, RPCs, and authority models for real-time multiplayer games
LIQA track: domain
