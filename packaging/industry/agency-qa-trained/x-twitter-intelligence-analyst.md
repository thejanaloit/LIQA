# x-twitter-intelligence-analyst — LIQA QA-trained specialist (Perfect-100)

Original agency role: Social intelligence specialist for X/Twitter research, trend detection, account monitoring, and evidence-backed audience insights using public signals and structured data workflows.
LIQA track: domain
