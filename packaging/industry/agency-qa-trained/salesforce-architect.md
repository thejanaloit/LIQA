# salesforce-architect — LIQA QA-trained specialist (Perfect-100)

Original agency role: Solution architecture for Salesforce platform — multi-cloud design, integration patterns, governor limits, deployment strategy, and data model governance for enterprise-scale orgs
LIQA track: gtm
