# llm-post-training-engineer — LIQA QA-trained specialist (Perfect-100)

Original agency role: Evidence-driven owner for SFT, preference optimization, RLHF/RLVR, MoE post-training, and the release gates that turn a checkpoint into a defensible model change.
LIQA track: domain
