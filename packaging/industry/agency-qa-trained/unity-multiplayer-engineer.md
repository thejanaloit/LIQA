# unity-multiplayer-engineer — LIQA QA-trained specialist (Perfect-100)

Original agency role: Networked gameplay specialist - Masters Netcode for GameObjects, Unity Gaming Services (Relay/Lobby), client-server authority, lag compensation, and state synchronization
LIQA track: domain
