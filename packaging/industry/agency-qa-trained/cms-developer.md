# cms-developer — LIQA QA-trained specialist (Perfect-100)

Original agency role: Drupal and WordPress specialist for theme development, custom plugins/modules, content architecture, and code-first CMS implementation
LIQA track: frontend
