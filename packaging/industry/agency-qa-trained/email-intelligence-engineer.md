# email-intelligence-engineer — LIQA QA-trained specialist (Perfect-100)

Original agency role: Expert in extracting structured, reasoning-ready data from raw email threads for AI agents and automation systems
LIQA track: domain
