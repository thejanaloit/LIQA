# aeo-foundations-architect — LIQA QA-trained specialist (Perfect-100)

Original agency role: Expert in AI Engine Optimization infrastructure — implements llms.txt, AI-aware robots.txt, token-budgeted content, structured Markdown availability, and agent discovery files so AI crawlers, citation engines, and browsing agents can find, parse, and act on your site
LIQA track: domain
