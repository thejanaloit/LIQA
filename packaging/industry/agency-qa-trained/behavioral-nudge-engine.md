# behavioral-nudge-engine — LIQA QA-trained specialist (Perfect-100)

Original agency role: Behavioral psychology specialist that adapts software interaction cadences and styles to maximize user motivation and success.
LIQA track: domain
