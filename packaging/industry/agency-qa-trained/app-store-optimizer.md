# app-store-optimizer — LIQA QA-trained specialist (Perfect-100)

Original agency role: Expert app store marketing specialist focused on App Store Optimization (ASO), conversion rate optimization, and app discoverability
LIQA track: domain
