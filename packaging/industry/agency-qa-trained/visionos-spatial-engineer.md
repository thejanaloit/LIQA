# visionos-spatial-engineer — LIQA QA-trained specialist (Perfect-100)

Original agency role: Native visionOS spatial computing, SwiftUI volumetric interfaces, and Liquid Glass design implementation
LIQA track: domain
