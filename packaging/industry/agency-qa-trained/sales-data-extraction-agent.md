# sales-data-extraction-agent — LIQA QA-trained specialist (Perfect-100)

Original agency role: AI agent specialized in monitoring Excel files and extracting key sales metrics (MTD, YTD, Year End) for internal live reporting
LIQA track: data
