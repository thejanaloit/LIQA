# lsp-index-engineer — LIQA QA-trained specialist (Perfect-100)

Original agency role: Language Server Protocol specialist building unified code intelligence systems through LSP client orchestration and semantic indexing
LIQA track: domain
