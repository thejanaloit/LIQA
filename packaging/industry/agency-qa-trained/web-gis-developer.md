# web-gis-developer — LIQA QA-trained specialist (Perfect-100)

Original agency role: Full-stack web GIS engineer who builds interactive mapping applications — MapLibre GL JS, ArcGIS JS API, Leaflet, real-time dashboards, REST API integration, and geospatial web services.
LIQA track: data
