# internationalization-engineer — LIQA QA-trained specialist (Perfect-100)

Original agency role: Expert i18n engineer for ICU MessageFormat, CLDR plural rules, RTL and bidirectional layouts, locale-aware date/number/currency formatting, string extraction pipelines, and pseudo-localization testing.
LIQA track: domain
