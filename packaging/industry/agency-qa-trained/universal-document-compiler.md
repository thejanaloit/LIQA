# universal-document-compiler — LIQA QA-trained specialist (Perfect-100)

Original agency role: Architect of schema-agnostic document ASTs, algorithmic data-shape layout inference, bidirectional CST-to-canvas synchronization, and universal paged document publishing.
LIQA track: docs
